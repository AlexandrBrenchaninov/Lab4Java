package bsu.rfe.java.group6.lab4.Brenchaninov.varA;
...
public class GraphicsDisplay extends JPanel {
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        for (Double[] point: graphicsData) {
            ...
            Ellipse2D.Double marker3 = new Ellipse2D.Double();
            Point2D.Double center = xyToPoint(point[0], point[1]);
            Point2D.Double corner = shiftPoint4(center, 11, 11);
            ...
            marker3.setFrameFromCenter(center, corner3);
            canvas.draw(marker3);
        ...
        /*Double[] specialPoint = {1.0, 0.0};
            ...
            Point2D.Double dashStart = shiftPoint(specialCenter, 0, maxY - minY);
            Point2D.Double dashEnd = shiftPoint(specialCenter, 0, minY - maxY);
    ...
    protected void paintAxis(Graphics2D canvas) {
        ...
        if (minX<=0.0 && maxX>=0.0) {
          ...
          /*canvas.drawString("2", (float)labelPos.getX() +60, (float)(labelPos2.getY() - bounds.getY()));*/
        }
